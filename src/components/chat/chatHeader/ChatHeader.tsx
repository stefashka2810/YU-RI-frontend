    ...
    return (
        <div className="flex flex-row items-center justify-between mt-[1vw] pl-[1vw] py-[1vw] pr-[1vw] w-full bg-transparent relative z-30">
            <div className="flex flex-row items-center gap-[0.5vw]">
                <button 
                    className="flex flex-row items-center gap-[0.5vw] bg-[#FFFFFF1A] border-1 border-[#FFFFFF1A] rounded-[10px] px-[1vw] py-[0.5vw] text-white text-[0.75vw] hover:bg-[#252525] whitespace-nowrap"
            ...
            {!isEditorOpen && (
                <button 
                    className="bg-[#1A1A1A] rounded-[10px] px-[1vw] py-[0.5vw] border-1 border-[#FFFFFF1A] text-white text-[0.75vw] hover:bg-[#252525] whitespace-nowrap"
