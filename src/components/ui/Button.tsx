...
const Button = ({children, onClick}: {children: ReactNode, onClick?: () => void}) => {
    return (
        <button
            onClick={onClick}
            className='inline-block text-[14px] rounded-[100px] w-[30vw] h-[5.5vw] font-medium hover:cursor-pointer relative transition-all duration-300 ease-in-out hover:bg-white/90 hover:scale-105 will-change-transform'
            style={{
